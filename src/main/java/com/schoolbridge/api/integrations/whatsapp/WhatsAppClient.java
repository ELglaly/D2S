 ...
 * pre-approved template. Free-form {@link #sendText} is reserved for later modules (M11 parent↔
...
public interface WhatsAppClient {
   ...
   * @param language template language (matches Meta's {@code language.code}; AR → {@code ar}, EN →
   *     {@code en})
   ...
   * M7 — kept on the port so M11 doesn't need to widen the interface.
   */
