 ...
 * than by phone — and because "was this parent notified" should have one answer keyed to a person,
 ...
 * @param phone E.164 number, or null when the user has none — the phone channels then simply fall
 *     through
 */
