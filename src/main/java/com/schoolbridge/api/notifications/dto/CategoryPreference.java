 ...
 * an empty list is not how a user opts out â€” {@code enabled = false} is â€” and silently
 * accepting an empty list would produce a preference that can never deliver anything while still
 * reading as "on".
 *
