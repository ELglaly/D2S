 ...
 * </pre>
 *
 * <p>The body is forwarded chunk by chunk and never held whole in memory â€” at the configured
 * upload cap, buffering per concurrent upload is how a scanner turns into an availability problem.
 *
