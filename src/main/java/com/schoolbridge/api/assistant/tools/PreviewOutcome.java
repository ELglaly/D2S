 ...
 * ActionPreview} (the orchestrator halts and asks the user), or a {@link ToolResult} rejection â€”
 * denied or clarify â€” that is fed back to the model so it can explain or ask for more detail.
 */
