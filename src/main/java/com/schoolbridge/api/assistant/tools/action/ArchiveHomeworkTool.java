 ...
 */
@Component
public class ArchiveHomeworkTool extends AbstractActionTool {

  private final HomeworkService homework;
  private final PermissionsHelper perms;

  public ArchiveHomeworkTool(
  ...
  @Override
  public String name() {
    return "archive_homework";
  }

  @Override
  public String description() {
    return "Archive (soft-delete) a homework item so it no longer appears to parents.";
  }
  ...
  protected PrepResult prepare(JsonNode args, ToolContext ctx) {
    ...
    String en = "I'll archive \"" + hw.value().subject() + "\". Confirm?";
    String ar = "سأؤرشف «" + hw.value().subject() + "». أؤكّد؟";
